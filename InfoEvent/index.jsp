							...
							<section class="tiles">
								<article class="style1">
									...
									<a href="generic.html">
										<h2>Seminar</h2>
										<div class="content">
											<p>Sebuah seminar yang membuat anda bersemangat untuk membangun apa yang anda inginkans</p>
										</div>
									</a>
								</article>
								<article class="style1">
									...
									<a href="generic.html">
										<h2>Workshop</h2>
										<div class="content">
											<p>Workshop untuk anda para pecinta design</p>
										</div>
									</a>
								</article>
								<article class="style1">
									...
									<a href="other.jsp">
										<h2>Other</h2>
										<div class="content">
											<p>Event-event yang tentunya menyenangkan</p>
										</div>
									</a>
							</section>
						</div>
