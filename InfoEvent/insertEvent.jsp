            ...
            %>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1 style="text-align: center;">Insert Event</h1>
							</header>
							<section class="tiles">
								<form method="post" action="controller/doInsertEvent.jsp" style="text-align: center;margin-left: 5%;background-color: inherit;padding: 1em;" >
									<div class="field">
										<input type="text" name="eventname"  placeholder="Event Name" />
									</div>
									
									<div class="field">
										<input type="text" name="category" placeholder="seminar/workshop/other">
									</div>
